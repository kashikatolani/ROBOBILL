...
genai.configure(api_key="AIzaSyBXFMEcYUHXJBRuBlhlmJTy026p1jcZxAU")
...
st.set_page_config(page_title="Kashika's Invoice Generator")
st.sidebar.header("RoboBill")
st.sidebar.write("Made by Kashika")
st.sidebar.write("Powered by Google Gemini Ai")
st.header("RoboBill")
st.subheader("Made by Kashika")
